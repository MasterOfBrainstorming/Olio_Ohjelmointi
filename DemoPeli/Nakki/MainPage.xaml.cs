...
namespace Nakki
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        // Create new flower and set flower location with cursor
        ...
        private void CheckCollision()
        {
            ...
            {
                //if (butterfly.LocationX == flower.LocationX && butterfly.LocationY == flower.LocationY)
                // get rects
